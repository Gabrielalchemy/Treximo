  ...
  return (
    ...
    >
      <motion.path
        ...
        style={{ filter: 'drop-shadow(0 0 6px rgba(200,255,46,0.35))' }}
      />
      <motion.circle
        cx={path.startX}
        cy={path.startY}
      ...
      >
        <circle cx={path.endX} cy={path.endY} r={9} fill="rgba(200,255,46,0.25)" />
        <circle cx={path.endX} cy={path.endY} r={4.5} fill="#C8FF2E" />
      </motion.g>
    </svg>
  )
}
